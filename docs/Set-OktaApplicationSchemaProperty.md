...
### -Max
Max string length or numeric value
...
### -Min
Min string length or numeric value
...
### -Type
Value type, string, boolean, number, integer
...
### -UserScope
Set if only on the user personal scope
