...
Disable-OktaZone | Disable-OktaZone [-ZoneId] <string> [-WhatIf] [-Confirm] [<CommonParameters>]
Enable-OktaZone | Enable-OktaZone [-ZoneId] <string> [-WhatIf] [-Confirm] [<CommonParameters>]
...
Get-OktaZone | Get-OktaZone [-Usage <string>] [-Limit <uint>] [-Json] [<CommonParameters>]
...
ipAddresses | ipAddresses [[-cidr] <Object>] [[-range] <Object>]
New-OktaAuthProviderUser | Add a user for an Authentication Provider
New-OktaBlockListZone | New-OktaBlockListZone [-Name] <string> [[-GatewayCIDR] <string[]>] [[-GatewayRange] <string[]>] [[-ProxyCIDR] <string[]>] [[-ProxyRange] <string[]>] [-Inactive] [-WhatIf] [-Confirm] [<CommonParameters>]
New-OktaDynamicZone | New-OktaDynamicZone [-Name] <string> [[-Locations] <hashtable[]>] [[-ASNs] <string[]>] [[-ProxyType] <string>] [-Inactive] [-WhatIf] [-Confirm] [<CommonParameters>]
...
Remove-OktaZone | Remove-OktaZone [-ZoneId] <string> [-WhatIf] [-Confirm] [<CommonParameters>]
Set-OktaOption | Set OktaOptions for accessing the API
Set-OktaZone | Set-OktaZone -Zone <psobject> [-WhatIf] [-Confirm] [<CommonParameters>]
...
New-OktaPolicyZone | New-OktaPolicyZone [-Name] <string> [[-GatewayCIDR] <string[]>] [[-GatewayRange] <string[]>] [[-ProxyCIDR] <string[]>] [[-ProxyRange] <string[]>] [-Inactive] [-WhatIf] [-Confirm] [<CommonParameters>]
...
---
Generated by New-HelpOutput.ps1 on 05/29/2021 12:05:46
