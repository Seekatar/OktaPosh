...
ConvertTo-OktaApplicationYaml | ConvertTo-OktaApplicationYaml [[-Query] <string>] [-OutputFolder] <string> [<CommonParameters>]
...
Command     | Synopsis
------------|---------|
ConvertTo-OktaAuthorizationYaml | ConvertTo-OktaAuthorizationYaml [-Folder] <string> [<CommonParameters>]
...
------------|---------|
addUser | synopsis
ConvertTo-OktaYaml | ConvertTo-OktaYaml [-Folder] <string> [[-AuthServerQuery] <string>] [[-ApplicationQuery] <string>] [[-OriginMask] <string>] [-WipeFolder] [<CommonParameters>]
...
Command     | Synopsis
------------|---------|
ConvertTo-OktaTrustedOriginYaml | ConvertTo-OktaTrustedOriginYaml [[-Mask] <string>] [<CommonParameters>]
...
---
Generated by New-HelpOutput.ps1 on 06/17/2021 20:34:13
